...
public class C01_EndToEnd {
    ...
    public void createHotel() throws InterruptedException {
        ...
        Thread.sleep(7000);
        hotelMyCampPage.hotelmangement.click();
        ...
        actions.click(hotelMyCampPage.addHotelcode).sendKeys(faker.address().zipCode()).sendKeys(Keys.TAB)
                ...
                .sendKeys(faker.internet().emailAddress()).sendKeys(Keys.PAGE_DOWN).perform();
        Select select=new Select(hotelMyCampPage.addselectGroup);
